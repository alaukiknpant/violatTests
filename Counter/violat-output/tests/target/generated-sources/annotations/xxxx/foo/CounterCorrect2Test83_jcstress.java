...
import xxxx.foo.CounterCorrect2Test83;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test83_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test83_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test83");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test83 t = new CounterCorrect2Test83();
        final CounterCorrect2Test83 s = new CounterCorrect2Test83();
    ...
    static class Pair {
        public CounterCorrect2Test83 s;
