...
import xxxx.foo.CounterCorrect2Test95;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test95_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test95_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test95");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test95 t = new CounterCorrect2Test95();
        final CounterCorrect2Test95 s = new CounterCorrect2Test95();
    ...
    static class Pair {
        public CounterCorrect2Test95 s;
