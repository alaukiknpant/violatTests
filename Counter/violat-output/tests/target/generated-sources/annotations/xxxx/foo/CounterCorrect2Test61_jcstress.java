...
import xxxx.foo.CounterCorrect2Test61;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test61_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test61_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test61");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test61 t = new CounterCorrect2Test61();
        final CounterCorrect2Test61 s = new CounterCorrect2Test61();
    ...
    static class Pair {
        public CounterCorrect2Test61 s;
