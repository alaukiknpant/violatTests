...
import xxxx.foo.CounterCorrect2Test60;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test60_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test60_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test60");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test60 t = new CounterCorrect2Test60();
        final CounterCorrect2Test60 s = new CounterCorrect2Test60();
    ...
    static class Pair {
        public CounterCorrect2Test60 s;
