...
import xxxx.foo.CounterCorrect2Test44;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test44_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test44_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test44");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test44 t = new CounterCorrect2Test44();
        final CounterCorrect2Test44 s = new CounterCorrect2Test44();
    ...
    static class Pair {
        public CounterCorrect2Test44 s;
