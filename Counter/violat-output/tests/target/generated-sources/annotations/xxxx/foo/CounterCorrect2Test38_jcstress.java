...
import xxxx.foo.CounterCorrect2Test38;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test38_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test38_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test38");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test38 t = new CounterCorrect2Test38();
        final CounterCorrect2Test38 s = new CounterCorrect2Test38();
    ...
    static class Pair {
        public CounterCorrect2Test38 s;
