...
import xxxx.foo.CounterCorrect2Test41;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test41_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test41_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test41");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test41 t = new CounterCorrect2Test41();
        final CounterCorrect2Test41 s = new CounterCorrect2Test41();
    ...
    static class Pair {
        public CounterCorrect2Test41 s;
