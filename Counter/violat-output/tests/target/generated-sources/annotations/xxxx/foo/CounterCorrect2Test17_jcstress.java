...
import xxxx.foo.CounterCorrect2Test17;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test17_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test17_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test17");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test17 t = new CounterCorrect2Test17();
        final CounterCorrect2Test17 s = new CounterCorrect2Test17();
    ...
    static class Pair {
        public CounterCorrect2Test17 s;
