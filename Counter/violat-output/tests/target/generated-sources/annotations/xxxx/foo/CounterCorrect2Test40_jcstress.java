...
import xxxx.foo.CounterCorrect2Test40;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test40_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test40_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test40");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test40 t = new CounterCorrect2Test40();
        final CounterCorrect2Test40 s = new CounterCorrect2Test40();
    ...
    static class Pair {
        public CounterCorrect2Test40 s;
