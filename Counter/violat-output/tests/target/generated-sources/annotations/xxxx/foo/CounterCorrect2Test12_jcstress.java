...
import xxxx.foo.CounterCorrect2Test12;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test12_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test12_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test12");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test12 t = new CounterCorrect2Test12();
        final CounterCorrect2Test12 s = new CounterCorrect2Test12();
    ...
    static class Pair {
        public CounterCorrect2Test12 s;
