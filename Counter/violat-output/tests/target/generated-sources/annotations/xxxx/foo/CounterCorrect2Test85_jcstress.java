...
import xxxx.foo.CounterCorrect2Test85;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test85_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test85_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test85");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test85 t = new CounterCorrect2Test85();
        final CounterCorrect2Test85 s = new CounterCorrect2Test85();
    ...
    static class Pair {
        public CounterCorrect2Test85 s;
