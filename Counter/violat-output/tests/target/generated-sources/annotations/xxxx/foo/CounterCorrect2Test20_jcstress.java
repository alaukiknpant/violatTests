...
import xxxx.foo.CounterCorrect2Test20;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test20_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test20_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test20");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test20 t = new CounterCorrect2Test20();
        final CounterCorrect2Test20 s = new CounterCorrect2Test20();
    ...
    static class Pair {
        public CounterCorrect2Test20 s;
