...
import xxxx.foo.CounterCorrect2Test5;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test5_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test5_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test5");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test5 t = new CounterCorrect2Test5();
        final CounterCorrect2Test5 s = new CounterCorrect2Test5();
