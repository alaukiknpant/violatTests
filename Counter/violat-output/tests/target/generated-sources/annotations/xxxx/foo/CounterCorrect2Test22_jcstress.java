...
import xxxx.foo.CounterCorrect2Test22;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test22_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test22_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test22");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test22 t = new CounterCorrect2Test22();
        final CounterCorrect2Test22 s = new CounterCorrect2Test22();
    ...
    static class Pair {
        public CounterCorrect2Test22 s;
