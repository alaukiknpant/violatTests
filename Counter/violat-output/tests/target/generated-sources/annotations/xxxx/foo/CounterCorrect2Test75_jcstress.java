...
import xxxx.foo.CounterCorrect2Test75;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test75_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test75_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test75");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test75 t = new CounterCorrect2Test75();
        final CounterCorrect2Test75 s = new CounterCorrect2Test75();
    ...
    static class Pair {
        public CounterCorrect2Test75 s;
