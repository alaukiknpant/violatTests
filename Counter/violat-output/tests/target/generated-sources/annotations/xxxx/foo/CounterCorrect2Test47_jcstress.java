...
import xxxx.foo.CounterCorrect2Test47;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test47_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test47_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test47");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test47 t = new CounterCorrect2Test47();
        final CounterCorrect2Test47 s = new CounterCorrect2Test47();
    ...
    static class Pair {
        public CounterCorrect2Test47 s;
