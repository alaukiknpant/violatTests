...
import xxxx.foo.CounterCorrect2Test31;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test31_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test31_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test31");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test31 t = new CounterCorrect2Test31();
        final CounterCorrect2Test31 s = new CounterCorrect2Test31();
    ...
    static class Pair {
        public CounterCorrect2Test31 s;
