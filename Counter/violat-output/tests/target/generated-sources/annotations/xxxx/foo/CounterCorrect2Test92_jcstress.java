...
import xxxx.foo.CounterCorrect2Test92;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test92_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test92_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test92");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test92 t = new CounterCorrect2Test92();
        final CounterCorrect2Test92 s = new CounterCorrect2Test92();
    ...
    static class Pair {
        public CounterCorrect2Test92 s;
