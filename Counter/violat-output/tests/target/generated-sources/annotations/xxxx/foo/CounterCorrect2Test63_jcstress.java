...
import xxxx.foo.CounterCorrect2Test63;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test63_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test63_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test63");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test63 t = new CounterCorrect2Test63();
        final CounterCorrect2Test63 s = new CounterCorrect2Test63();
    ...
    static class Pair {
        public CounterCorrect2Test63 s;
