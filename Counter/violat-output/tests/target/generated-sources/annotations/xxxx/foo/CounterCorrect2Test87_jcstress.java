...
import xxxx.foo.CounterCorrect2Test87;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test87_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test87_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test87");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test87 t = new CounterCorrect2Test87();
        final CounterCorrect2Test87 s = new CounterCorrect2Test87();
    ...
    static class Pair {
        public CounterCorrect2Test87 s;
