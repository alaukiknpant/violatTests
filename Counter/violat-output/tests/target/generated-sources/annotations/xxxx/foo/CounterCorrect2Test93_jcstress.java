...
import xxxx.foo.CounterCorrect2Test93;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test93_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test93_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test93");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test93 t = new CounterCorrect2Test93();
        final CounterCorrect2Test93 s = new CounterCorrect2Test93();
    ...
    static class Pair {
        public CounterCorrect2Test93 s;
