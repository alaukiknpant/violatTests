...
import xxxx.foo.CounterCorrect2Test80;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test80_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test80_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test80");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test80 t = new CounterCorrect2Test80();
        final CounterCorrect2Test80 s = new CounterCorrect2Test80();
    ...
    static class Pair {
        public CounterCorrect2Test80 s;
