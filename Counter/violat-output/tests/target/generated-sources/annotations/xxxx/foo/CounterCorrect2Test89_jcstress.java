...
import xxxx.foo.CounterCorrect2Test89;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test89_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test89_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test89");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test89 t = new CounterCorrect2Test89();
        final CounterCorrect2Test89 s = new CounterCorrect2Test89();
    ...
    static class Pair {
        public CounterCorrect2Test89 s;
