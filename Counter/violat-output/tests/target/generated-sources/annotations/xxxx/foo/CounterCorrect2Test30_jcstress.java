...
import xxxx.foo.CounterCorrect2Test30;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test30_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test30_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test30");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test30 t = new CounterCorrect2Test30();
        final CounterCorrect2Test30 s = new CounterCorrect2Test30();
    ...
    static class Pair {
        public CounterCorrect2Test30 s;
