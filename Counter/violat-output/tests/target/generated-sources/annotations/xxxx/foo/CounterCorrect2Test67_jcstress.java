...
import xxxx.foo.CounterCorrect2Test67;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test67_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test67_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test67");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test67 t = new CounterCorrect2Test67();
        final CounterCorrect2Test67 s = new CounterCorrect2Test67();
    ...
    static class Pair {
        public CounterCorrect2Test67 s;
