...
import xxxx.foo.CounterCorrect2Test37;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test37_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test37_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test37");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test37 t = new CounterCorrect2Test37();
        final CounterCorrect2Test37 s = new CounterCorrect2Test37();
    ...
    static class Pair {
        public CounterCorrect2Test37 s;
