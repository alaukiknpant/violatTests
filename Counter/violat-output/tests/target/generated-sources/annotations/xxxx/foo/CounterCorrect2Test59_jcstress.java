...
import xxxx.foo.CounterCorrect2Test59;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test59_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test59_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test59");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test59 t = new CounterCorrect2Test59();
        final CounterCorrect2Test59 s = new CounterCorrect2Test59();
    ...
    static class Pair {
        public CounterCorrect2Test59 s;
