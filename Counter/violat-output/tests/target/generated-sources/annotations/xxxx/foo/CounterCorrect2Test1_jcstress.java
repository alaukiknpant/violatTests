...
import xxxx.foo.CounterCorrect2Test1;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test1_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test1_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test1");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test1 t = new CounterCorrect2Test1();
        final CounterCorrect2Test1 s = new CounterCorrect2Test1();
