...
import xxxx.foo.CounterCorrect2Test39;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test39_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test39_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test39");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test39 t = new CounterCorrect2Test39();
        final CounterCorrect2Test39 s = new CounterCorrect2Test39();
    ...
    static class Pair {
        public CounterCorrect2Test39 s;
