...
import xxxx.foo.CounterCorrect2Test32;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test32_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test32_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test32");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test32 t = new CounterCorrect2Test32();
        final CounterCorrect2Test32 s = new CounterCorrect2Test32();
    ...
    static class Pair {
        public CounterCorrect2Test32 s;
