...
import xxxx.foo.CounterCorrect2Test79;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test79_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test79_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test79");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test79 t = new CounterCorrect2Test79();
        final CounterCorrect2Test79 s = new CounterCorrect2Test79();
    ...
    static class Pair {
        public CounterCorrect2Test79 s;
