...
import xxxx.foo.CounterCorrect2Test6;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test6_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test6_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test6");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test6 t = new CounterCorrect2Test6();
        final CounterCorrect2Test6 s = new CounterCorrect2Test6();
