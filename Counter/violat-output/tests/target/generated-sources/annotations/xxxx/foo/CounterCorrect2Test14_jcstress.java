...
import xxxx.foo.CounterCorrect2Test14;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test14_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test14_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test14");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test14 t = new CounterCorrect2Test14();
        final CounterCorrect2Test14 s = new CounterCorrect2Test14();
    ...
    static class Pair {
        public CounterCorrect2Test14 s;
