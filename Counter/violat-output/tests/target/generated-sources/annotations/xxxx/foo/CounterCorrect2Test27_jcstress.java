...
import xxxx.foo.CounterCorrect2Test27;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test27_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test27_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test27");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test27 t = new CounterCorrect2Test27();
        final CounterCorrect2Test27 s = new CounterCorrect2Test27();
    ...
    static class Pair {
        public CounterCorrect2Test27 s;
