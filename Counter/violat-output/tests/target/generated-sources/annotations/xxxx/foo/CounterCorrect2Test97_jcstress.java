...
import xxxx.foo.CounterCorrect2Test97;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test97_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test97_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test97");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test97 t = new CounterCorrect2Test97();
        final CounterCorrect2Test97 s = new CounterCorrect2Test97();
    ...
    static class Pair {
        public CounterCorrect2Test97 s;
