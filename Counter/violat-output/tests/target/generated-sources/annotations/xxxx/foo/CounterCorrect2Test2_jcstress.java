...
import xxxx.foo.CounterCorrect2Test2;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test2_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test2_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test2");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test2 t = new CounterCorrect2Test2();
        final CounterCorrect2Test2 s = new CounterCorrect2Test2();
