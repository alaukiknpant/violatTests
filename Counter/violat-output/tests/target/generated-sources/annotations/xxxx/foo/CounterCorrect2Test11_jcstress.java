...
import xxxx.foo.CounterCorrect2Test11;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test11_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test11_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test11");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test11 t = new CounterCorrect2Test11();
        final CounterCorrect2Test11 s = new CounterCorrect2Test11();
    ...
    static class Pair {
        public CounterCorrect2Test11 s;
