...
import xxxx.foo.CounterCorrect2Test49;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test49_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test49_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test49");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test49 t = new CounterCorrect2Test49();
        final CounterCorrect2Test49 s = new CounterCorrect2Test49();
    ...
    static class Pair {
        public CounterCorrect2Test49 s;
