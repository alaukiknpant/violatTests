...
import xxxx.foo.CounterCorrect2Test10;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test10_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test10_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test10");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test10 t = new CounterCorrect2Test10();
        final CounterCorrect2Test10 s = new CounterCorrect2Test10();
    ...
    static class Pair {
        public CounterCorrect2Test10 s;
