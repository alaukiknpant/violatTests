...
import xxxx.foo.CounterCorrect2Test55;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test55_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test55_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test55");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test55 t = new CounterCorrect2Test55();
        final CounterCorrect2Test55 s = new CounterCorrect2Test55();
    ...
    static class Pair {
        public CounterCorrect2Test55 s;
