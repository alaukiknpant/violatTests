...
import xxxx.foo.CounterCorrect2Test74;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test74_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test74_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test74");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test74 t = new CounterCorrect2Test74();
        final CounterCorrect2Test74 s = new CounterCorrect2Test74();
    ...
    static class Pair {
        public CounterCorrect2Test74 s;
