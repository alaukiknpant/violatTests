...
import xxxx.foo.CounterCorrect2Test15;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test15_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test15_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test15");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test15 t = new CounterCorrect2Test15();
        final CounterCorrect2Test15 s = new CounterCorrect2Test15();
    ...
    static class Pair {
        public CounterCorrect2Test15 s;
