...
import xxxx.foo.CounterCorrect2Test54;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test54_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test54_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test54");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test54 t = new CounterCorrect2Test54();
        final CounterCorrect2Test54 s = new CounterCorrect2Test54();
    ...
    static class Pair {
        public CounterCorrect2Test54 s;
