...
import xxxx.foo.CounterCorrect2Test88;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test88_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test88_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test88");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test88 t = new CounterCorrect2Test88();
        final CounterCorrect2Test88 s = new CounterCorrect2Test88();
    ...
    static class Pair {
        public CounterCorrect2Test88 s;
