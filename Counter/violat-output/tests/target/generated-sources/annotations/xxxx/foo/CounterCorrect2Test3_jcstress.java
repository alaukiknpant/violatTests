...
import xxxx.foo.CounterCorrect2Test3;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test3_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test3_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test3");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test3 t = new CounterCorrect2Test3();
        final CounterCorrect2Test3 s = new CounterCorrect2Test3();
