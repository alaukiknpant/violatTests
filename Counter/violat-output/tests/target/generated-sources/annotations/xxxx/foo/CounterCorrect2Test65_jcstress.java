...
import xxxx.foo.CounterCorrect2Test65;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test65_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test65_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test65");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test65 t = new CounterCorrect2Test65();
        final CounterCorrect2Test65 s = new CounterCorrect2Test65();
    ...
    static class Pair {
        public CounterCorrect2Test65 s;
