...
import xxxx.foo.CounterCorrect2Test19;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test19_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test19_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test19");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test19 t = new CounterCorrect2Test19();
        final CounterCorrect2Test19 s = new CounterCorrect2Test19();
    ...
    static class Pair {
        public CounterCorrect2Test19 s;
