...
import xxxx.foo.CounterCorrect2Test43;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test43_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test43_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test43");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test43 t = new CounterCorrect2Test43();
        final CounterCorrect2Test43 s = new CounterCorrect2Test43();
    ...
    static class Pair {
        public CounterCorrect2Test43 s;
