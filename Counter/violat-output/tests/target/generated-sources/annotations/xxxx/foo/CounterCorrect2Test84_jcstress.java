...
import xxxx.foo.CounterCorrect2Test84;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test84_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test84_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test84");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test84 t = new CounterCorrect2Test84();
        final CounterCorrect2Test84 s = new CounterCorrect2Test84();
    ...
    static class Pair {
        public CounterCorrect2Test84 s;
