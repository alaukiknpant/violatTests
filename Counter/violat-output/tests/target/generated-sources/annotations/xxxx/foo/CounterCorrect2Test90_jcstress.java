...
import xxxx.foo.CounterCorrect2Test90;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test90_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test90_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test90");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test90 t = new CounterCorrect2Test90();
        final CounterCorrect2Test90 s = new CounterCorrect2Test90();
    ...
    static class Pair {
        public CounterCorrect2Test90 s;
