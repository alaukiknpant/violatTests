...
import xxxx.foo.CounterCorrect2Test8;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test8_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test8_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test8");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test8 t = new CounterCorrect2Test8();
        final CounterCorrect2Test8 s = new CounterCorrect2Test8();
