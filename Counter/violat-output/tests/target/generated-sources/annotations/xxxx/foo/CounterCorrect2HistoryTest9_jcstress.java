...
import xxxx.foo.CounterCorrect2HistoryTest9;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class CounterCorrect2HistoryTest9_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public CounterCorrect2HistoryTest9_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2HistoryTest9");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2HistoryTest9 t = new CounterCorrect2HistoryTest9();
        final CounterCorrect2HistoryTest9 s = new CounterCorrect2HistoryTest9();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new CounterCorrect2HistoryTest9();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult2_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            CounterCorrect2HistoryTest9 s = p.s;
            p.s = new CounterCorrect2HistoryTest9();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public CounterCorrect2HistoryTest9 s;
