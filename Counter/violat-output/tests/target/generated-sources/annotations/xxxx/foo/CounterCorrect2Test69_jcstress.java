...
import xxxx.foo.CounterCorrect2Test69;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test69_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test69_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test69");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test69 t = new CounterCorrect2Test69();
        final CounterCorrect2Test69 s = new CounterCorrect2Test69();
    ...
    static class Pair {
        public CounterCorrect2Test69 s;
