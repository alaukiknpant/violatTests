...
import xxxx.foo.CounterCorrect2Test76;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test76_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test76_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test76");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test76 t = new CounterCorrect2Test76();
        final CounterCorrect2Test76 s = new CounterCorrect2Test76();
    ...
    static class Pair {
        public CounterCorrect2Test76 s;
