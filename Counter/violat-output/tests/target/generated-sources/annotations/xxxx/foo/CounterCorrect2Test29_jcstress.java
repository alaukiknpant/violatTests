...
import xxxx.foo.CounterCorrect2Test29;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test29_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test29_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test29");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test29 t = new CounterCorrect2Test29();
        final CounterCorrect2Test29 s = new CounterCorrect2Test29();
    ...
    static class Pair {
        public CounterCorrect2Test29 s;
