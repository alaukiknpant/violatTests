...
import xxxx.foo.CounterCorrect2Test62;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test62_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test62_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test62");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test62 t = new CounterCorrect2Test62();
        final CounterCorrect2Test62 s = new CounterCorrect2Test62();
    ...
    static class Pair {
        public CounterCorrect2Test62 s;
