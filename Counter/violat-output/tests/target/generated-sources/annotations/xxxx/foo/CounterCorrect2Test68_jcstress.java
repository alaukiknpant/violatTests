...
import xxxx.foo.CounterCorrect2Test68;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test68_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test68_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test68");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test68 t = new CounterCorrect2Test68();
        final CounterCorrect2Test68 s = new CounterCorrect2Test68();
    ...
    static class Pair {
        public CounterCorrect2Test68 s;
