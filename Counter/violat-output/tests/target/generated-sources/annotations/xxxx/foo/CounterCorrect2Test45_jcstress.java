...
import xxxx.foo.CounterCorrect2Test45;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test45_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test45_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test45");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test45 t = new CounterCorrect2Test45();
        final CounterCorrect2Test45 s = new CounterCorrect2Test45();
    ...
    static class Pair {
        public CounterCorrect2Test45 s;
