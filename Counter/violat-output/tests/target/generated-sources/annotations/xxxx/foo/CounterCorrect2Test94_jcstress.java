...
import xxxx.foo.CounterCorrect2Test94;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test94_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test94_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test94");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test94 t = new CounterCorrect2Test94();
        final CounterCorrect2Test94 s = new CounterCorrect2Test94();
    ...
    static class Pair {
        public CounterCorrect2Test94 s;
