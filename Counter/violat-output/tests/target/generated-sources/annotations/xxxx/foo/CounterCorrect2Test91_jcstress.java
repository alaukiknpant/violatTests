...
import xxxx.foo.CounterCorrect2Test91;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test91_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test91_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test91");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test91 t = new CounterCorrect2Test91();
        final CounterCorrect2Test91 s = new CounterCorrect2Test91();
    ...
    static class Pair {
        public CounterCorrect2Test91 s;
