...
import xxxx.foo.CounterCorrect2Test21;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test21_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test21_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test21");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test21 t = new CounterCorrect2Test21();
        final CounterCorrect2Test21 s = new CounterCorrect2Test21();
    ...
    static class Pair {
        public CounterCorrect2Test21 s;
