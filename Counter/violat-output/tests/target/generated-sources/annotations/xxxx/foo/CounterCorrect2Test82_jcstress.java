...
import xxxx.foo.CounterCorrect2Test82;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test82_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test82_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test82");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test82 t = new CounterCorrect2Test82();
        final CounterCorrect2Test82 s = new CounterCorrect2Test82();
    ...
    static class Pair {
        public CounterCorrect2Test82 s;
