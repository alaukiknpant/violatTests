...
import xxxx.foo.CounterCorrect2Test98;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test98_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test98_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test98");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test98 t = new CounterCorrect2Test98();
        final CounterCorrect2Test98 s = new CounterCorrect2Test98();
    ...
    static class Pair {
        public CounterCorrect2Test98 s;
