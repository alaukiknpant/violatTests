...
import xxxx.foo.CounterCorrect2Test25;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test25_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test25_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test25");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test25 t = new CounterCorrect2Test25();
        final CounterCorrect2Test25 s = new CounterCorrect2Test25();
    ...
    static class Pair {
        public CounterCorrect2Test25 s;
