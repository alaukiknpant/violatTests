...
import xxxx.foo.CounterCorrect2Test13;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test13_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test13_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test13");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test13 t = new CounterCorrect2Test13();
        final CounterCorrect2Test13 s = new CounterCorrect2Test13();
    ...
    static class Pair {
        public CounterCorrect2Test13 s;
