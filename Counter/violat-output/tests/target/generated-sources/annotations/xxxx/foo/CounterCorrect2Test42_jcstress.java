...
import xxxx.foo.CounterCorrect2Test42;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test42_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test42_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test42");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test42 t = new CounterCorrect2Test42();
        final CounterCorrect2Test42 s = new CounterCorrect2Test42();
    ...
    static class Pair {
        public CounterCorrect2Test42 s;
