...
import xxxx.foo.CounterCorrect2Test18;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test18_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test18_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test18");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test18 t = new CounterCorrect2Test18();
        final CounterCorrect2Test18 s = new CounterCorrect2Test18();
    ...
    static class Pair {
        public CounterCorrect2Test18 s;
