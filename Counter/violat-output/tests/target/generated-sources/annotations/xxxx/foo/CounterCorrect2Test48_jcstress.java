...
import xxxx.foo.CounterCorrect2Test48;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test48_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test48_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test48");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test48 t = new CounterCorrect2Test48();
        final CounterCorrect2Test48 s = new CounterCorrect2Test48();
    ...
    static class Pair {
        public CounterCorrect2Test48 s;
