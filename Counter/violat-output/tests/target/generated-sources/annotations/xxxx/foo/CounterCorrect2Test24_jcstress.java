...
import xxxx.foo.CounterCorrect2Test24;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test24_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test24_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test24");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test24 t = new CounterCorrect2Test24();
        final CounterCorrect2Test24 s = new CounterCorrect2Test24();
    ...
    static class Pair {
        public CounterCorrect2Test24 s;
