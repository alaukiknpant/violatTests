...
import xxxx.foo.CounterCorrect2Test73;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test73_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test73_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test73");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test73 t = new CounterCorrect2Test73();
        final CounterCorrect2Test73 s = new CounterCorrect2Test73();
    ...
    static class Pair {
        public CounterCorrect2Test73 s;
