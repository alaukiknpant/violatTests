...
import xxxx.foo.CounterCorrect2Test4;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test4_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test4_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test4");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test4 t = new CounterCorrect2Test4();
        final CounterCorrect2Test4 s = new CounterCorrect2Test4();
