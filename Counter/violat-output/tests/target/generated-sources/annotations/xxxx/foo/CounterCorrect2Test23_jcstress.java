...
import xxxx.foo.CounterCorrect2Test23;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test23_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test23_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test23");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test23 t = new CounterCorrect2Test23();
        final CounterCorrect2Test23 s = new CounterCorrect2Test23();
    ...
    static class Pair {
        public CounterCorrect2Test23 s;
