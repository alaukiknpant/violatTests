...
import xxxx.foo.CounterCorrect2Test51;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test51_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test51_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test51");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test51 t = new CounterCorrect2Test51();
        final CounterCorrect2Test51 s = new CounterCorrect2Test51();
    ...
    static class Pair {
        public CounterCorrect2Test51 s;
