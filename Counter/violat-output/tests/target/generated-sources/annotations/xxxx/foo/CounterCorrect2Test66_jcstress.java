...
import xxxx.foo.CounterCorrect2Test66;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test66_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test66_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test66");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test66 t = new CounterCorrect2Test66();
        final CounterCorrect2Test66 s = new CounterCorrect2Test66();
    ...
    static class Pair {
        public CounterCorrect2Test66 s;
