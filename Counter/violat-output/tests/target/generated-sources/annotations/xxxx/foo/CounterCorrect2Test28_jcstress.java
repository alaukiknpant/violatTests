...
import xxxx.foo.CounterCorrect2Test28;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test28_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test28_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test28");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test28 t = new CounterCorrect2Test28();
        final CounterCorrect2Test28 s = new CounterCorrect2Test28();
    ...
    static class Pair {
        public CounterCorrect2Test28 s;
