...
import xxxx.foo.CounterCorrect2Test7;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test7_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test7_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test7");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test7 t = new CounterCorrect2Test7();
        final CounterCorrect2Test7 s = new CounterCorrect2Test7();
