...
import xxxx.foo.CounterCorrect2Test78;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test78_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test78_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test78");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test78 t = new CounterCorrect2Test78();
        final CounterCorrect2Test78 s = new CounterCorrect2Test78();
    ...
    static class Pair {
        public CounterCorrect2Test78 s;
