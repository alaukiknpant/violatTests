...
import xxxx.foo.CounterCorrect2Test99;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test99_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test99_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test99");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test99 t = new CounterCorrect2Test99();
        final CounterCorrect2Test99 s = new CounterCorrect2Test99();
    ...
    static class Pair {
        public CounterCorrect2Test99 s;
