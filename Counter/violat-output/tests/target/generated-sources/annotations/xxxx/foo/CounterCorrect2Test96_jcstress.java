...
import xxxx.foo.CounterCorrect2Test96;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test96_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test96_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test96");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test96 t = new CounterCorrect2Test96();
        final CounterCorrect2Test96 s = new CounterCorrect2Test96();
    ...
    static class Pair {
        public CounterCorrect2Test96 s;
