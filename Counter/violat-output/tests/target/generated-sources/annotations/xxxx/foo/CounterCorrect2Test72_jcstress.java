...
import xxxx.foo.CounterCorrect2Test72;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test72_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test72_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test72");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test72 t = new CounterCorrect2Test72();
        final CounterCorrect2Test72 s = new CounterCorrect2Test72();
    ...
    static class Pair {
        public CounterCorrect2Test72 s;
