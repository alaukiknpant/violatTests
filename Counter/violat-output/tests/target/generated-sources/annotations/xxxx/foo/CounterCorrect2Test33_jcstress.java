...
import xxxx.foo.CounterCorrect2Test33;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test33_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test33_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test33");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test33 t = new CounterCorrect2Test33();
        final CounterCorrect2Test33 s = new CounterCorrect2Test33();
    ...
    static class Pair {
        public CounterCorrect2Test33 s;
