...
import xxxx.foo.CounterCorrect2Test16;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test16_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test16_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test16");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test16 t = new CounterCorrect2Test16();
        final CounterCorrect2Test16 s = new CounterCorrect2Test16();
    ...
    static class Pair {
        public CounterCorrect2Test16 s;
