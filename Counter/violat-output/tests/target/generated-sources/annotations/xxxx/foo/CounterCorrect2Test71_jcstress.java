...
import xxxx.foo.CounterCorrect2Test71;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test71_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test71_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test71");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test71 t = new CounterCorrect2Test71();
        final CounterCorrect2Test71 s = new CounterCorrect2Test71();
    ...
    static class Pair {
        public CounterCorrect2Test71 s;
