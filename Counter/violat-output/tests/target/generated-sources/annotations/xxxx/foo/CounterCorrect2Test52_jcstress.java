...
import xxxx.foo.CounterCorrect2Test52;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test52_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test52_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test52");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test52 t = new CounterCorrect2Test52();
        final CounterCorrect2Test52 s = new CounterCorrect2Test52();
    ...
    static class Pair {
        public CounterCorrect2Test52 s;
