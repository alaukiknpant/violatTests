...
import xxxx.foo.CounterCorrect2Test9;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test9_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test9_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test9");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test9 t = new CounterCorrect2Test9();
        final CounterCorrect2Test9 s = new CounterCorrect2Test9();
