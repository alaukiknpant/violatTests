...
import xxxx.foo.CounterCorrect2Test58;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test58_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test58_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test58");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test58 t = new CounterCorrect2Test58();
        final CounterCorrect2Test58 s = new CounterCorrect2Test58();
    ...
    static class Pair {
        public CounterCorrect2Test58 s;
