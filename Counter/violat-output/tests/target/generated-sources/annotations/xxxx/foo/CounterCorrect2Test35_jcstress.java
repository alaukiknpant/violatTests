...
import xxxx.foo.CounterCorrect2Test35;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test35_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test35_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test35");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test35 t = new CounterCorrect2Test35();
        final CounterCorrect2Test35 s = new CounterCorrect2Test35();
    ...
    static class Pair {
        public CounterCorrect2Test35 s;
