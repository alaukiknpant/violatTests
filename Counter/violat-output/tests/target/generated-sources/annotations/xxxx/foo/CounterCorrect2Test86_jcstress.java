...
import xxxx.foo.CounterCorrect2Test86;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test86_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test86_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test86");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test86 t = new CounterCorrect2Test86();
        final CounterCorrect2Test86 s = new CounterCorrect2Test86();
    ...
    static class Pair {
        public CounterCorrect2Test86 s;
