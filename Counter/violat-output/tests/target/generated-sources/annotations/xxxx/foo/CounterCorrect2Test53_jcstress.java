...
import xxxx.foo.CounterCorrect2Test53;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test53_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test53_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test53");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test53 t = new CounterCorrect2Test53();
        final CounterCorrect2Test53 s = new CounterCorrect2Test53();
    ...
    static class Pair {
        public CounterCorrect2Test53 s;
