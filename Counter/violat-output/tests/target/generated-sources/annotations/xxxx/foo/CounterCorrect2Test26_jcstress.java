...
import xxxx.foo.CounterCorrect2Test26;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test26_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test26_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test26");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test26 t = new CounterCorrect2Test26();
        final CounterCorrect2Test26 s = new CounterCorrect2Test26();
    ...
    static class Pair {
        public CounterCorrect2Test26 s;
