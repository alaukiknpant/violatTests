...
import xxxx.foo.CounterCorrect2Test0;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test0_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test0_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test0");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test0 t = new CounterCorrect2Test0();
        final CounterCorrect2Test0 s = new CounterCorrect2Test0();
