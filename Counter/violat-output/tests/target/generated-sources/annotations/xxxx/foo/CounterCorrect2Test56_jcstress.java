...
import xxxx.foo.CounterCorrect2Test56;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test56_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test56_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test56");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test56 t = new CounterCorrect2Test56();
        final CounterCorrect2Test56 s = new CounterCorrect2Test56();
    ...
    static class Pair {
        public CounterCorrect2Test56 s;
