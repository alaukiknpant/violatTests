...
import xxxx.foo.CounterCorrect2HistoryTest15;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class CounterCorrect2HistoryTest15_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public CounterCorrect2HistoryTest15_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2HistoryTest15");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2HistoryTest15 t = new CounterCorrect2HistoryTest15();
        final CounterCorrect2HistoryTest15 s = new CounterCorrect2HistoryTest15();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new CounterCorrect2HistoryTest15();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult2_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            CounterCorrect2HistoryTest15 s = p.s;
            p.s = new CounterCorrect2HistoryTest15();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public CounterCorrect2HistoryTest15 s;
