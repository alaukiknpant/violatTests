...
import xxxx.foo.CounterCorrect2Test70;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test70_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test70_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test70");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test70 t = new CounterCorrect2Test70();
        final CounterCorrect2Test70 s = new CounterCorrect2Test70();
    ...
    static class Pair {
        public CounterCorrect2Test70 s;
