...
import xxxx.foo.CounterCorrect2Test46;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test46_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test46_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test46");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test46 t = new CounterCorrect2Test46();
        final CounterCorrect2Test46 s = new CounterCorrect2Test46();
    ...
    static class Pair {
        public CounterCorrect2Test46 s;
