...
import xxxx.foo.CounterCorrect2Test50;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test50_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test50_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test50");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test50 t = new CounterCorrect2Test50();
        final CounterCorrect2Test50 s = new CounterCorrect2Test50();
    ...
    static class Pair {
        public CounterCorrect2Test50 s;
