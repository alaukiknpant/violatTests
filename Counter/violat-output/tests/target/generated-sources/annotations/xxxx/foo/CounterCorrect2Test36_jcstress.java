...
import xxxx.foo.CounterCorrect2Test36;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class CounterCorrect2Test36_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public CounterCorrect2Test36_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test36");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test36 t = new CounterCorrect2Test36();
        final CounterCorrect2Test36 s = new CounterCorrect2Test36();
    ...
    static class Pair {
        public CounterCorrect2Test36 s;
