...
import xxxx.foo.CounterCorrect2Test64;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test64_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test64_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test64");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test64 t = new CounterCorrect2Test64();
        final CounterCorrect2Test64 s = new CounterCorrect2Test64();
    ...
    static class Pair {
        public CounterCorrect2Test64 s;
