...
import xxxx.foo.CounterCorrect2Test81;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class CounterCorrect2Test81_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public CounterCorrect2Test81_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test81");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test81 t = new CounterCorrect2Test81();
        final CounterCorrect2Test81 s = new CounterCorrect2Test81();
    ...
    static class Pair {
        public CounterCorrect2Test81 s;
