...
import xxxx.foo.CounterCorrect2Test77;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class CounterCorrect2Test77_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public CounterCorrect2Test77_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test77");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test77 t = new CounterCorrect2Test77();
        final CounterCorrect2Test77 s = new CounterCorrect2Test77();
    ...
    static class Pair {
        public CounterCorrect2Test77 s;
