...
import xxxx.foo.CounterCorrect2Test34;
import org.openjdk.jcstress.infra.results.StringResult6_jcstress;

public class CounterCorrect2Test34_jcstress extends Runner<StringResult6_jcstress> {
    ...
    public CounterCorrect2Test34_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.CounterCorrect2Test34");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final CounterCorrect2Test34 t = new CounterCorrect2Test34();
        final CounterCorrect2Test34 s = new CounterCorrect2Test34();
    ...
    static class Pair {
        public CounterCorrect2Test34 s;
