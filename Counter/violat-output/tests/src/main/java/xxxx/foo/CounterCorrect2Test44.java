...
@JCStressTest
@Outcome(
    id = "4,\\s*5,\\s*1,\\s*2,\\s*3",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "3,\\s*5,\\s*1,\\s*2,\\s*4",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "3,\\s*4,\\s*1,\\s*2,\\s*5",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "2,\\s*5,\\s*1,\\s*3,\\s*4",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "2,\\s*4,\\s*1,\\s*3,\\s*5",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "2,\\s*3,\\s*1,\\s*4,\\s*5",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "1,\\s*5,\\s*2,\\s*3,\\s*4",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "1,\\s*4,\\s*2,\\s*3,\\s*5",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "1,\\s*3,\\s*2,\\s*4,\\s*5",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    ...
    desc = "atomic")
@State
public class CounterCorrect2Test44 {
