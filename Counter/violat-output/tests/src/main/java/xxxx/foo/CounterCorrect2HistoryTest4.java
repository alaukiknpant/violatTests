...
@State
public class CounterCorrect2HistoryTest4 {
    ...
    public void actor0(StringResult4 result) {
        ...
        result.r1 = "1@" + pcs[0][0] + ":" + "2@" + pcs[0][1] + ":" + "3@" + pcs[0][2] + "/" + "_" + ";" + "1@" + pcs[1][0] + ":" + "2@" + pcs[1][1] + ":" + "3@" + pcs[1][2] + "/" + r0;
    }
    ...
    public void actor1(StringResult4 result) {
        ...
        result.r2 = "0@" + pcs[0][0] + ":" + "2@" + pcs[0][1] + ":" + "3@" + pcs[0][2] + "/" + "_" + ";" + "0@" + pcs[1][0] + ":" + "2@" + pcs[1][1] + ":" + "3@" + pcs[1][2] + "/" + r0 + ";" + "0@" + pcs[2][0] + ":" + "2@" + pcs[2][1] + ":" + "3@" + pcs[2][2] + "/" + "_" + ";" + "0@" + pcs[3][0] + ":" + "2@" + pcs[3][1] + ":" + "3@" + pcs[3][2] + "/" + r1;
    }
    ...
    public void actor2(StringResult4 result) {
        ...
        result.r3 = "0@" + pcs[0][0] + ":" + "1@" + pcs[0][1] + ":" + "3@" + pcs[0][2] + "/" + "_" + ";" + "0@" + pcs[1][0] + ":" + "1@" + pcs[1][1] + ":" + "3@" + pcs[1][2] + "/" + r0 + ";" + "0@" + pcs[2][0] + ":" + "1@" + pcs[2][1] + ":" + "3@" + pcs[2][2] + "/" + "_" + ";" + "0@" + pcs[3][0] + ":" + "1@" + pcs[3][1] + ":" + "3@" + pcs[3][2] + "/" + r1;
    }
