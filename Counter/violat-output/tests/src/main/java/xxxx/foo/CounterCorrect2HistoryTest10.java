...
@State
public class CounterCorrect2HistoryTest10 {
    ...
    public void actor3(StringResult4 result) {
        ...
        result.r4 = "0@" + pcs[0][0] + ":" + "1@" + pcs[0][1] + ":" + "2@" + pcs[0][2] + "/" + "_" + ";" + "0@" + pcs[1][0] + ":" + "1@" + pcs[1][1] + ":" + "2@" + pcs[1][2] + "/" + r0 + ";" + "0@" + pcs[2][0] + ":" + "1@" + pcs[2][1] + ":" + "2@" + pcs[2][2] + "/" + "_" + ";" + "0@" + pcs[3][0] + ":" + "1@" + pcs[3][1] + ":" + "2@" + pcs[3][2] + "/" + r1;
    }
}
