...
import xxxx.foo.QueueSynchronizedTest26;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest26_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest26_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest26");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest26 t = new QueueSynchronizedTest26();
        final QueueSynchronizedTest26 s = new QueueSynchronizedTest26();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest26();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest26 s;
