...
import xxxx.foo.QueueSynchronizedTest24;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest24_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest24_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest24");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest24 t = new QueueSynchronizedTest24();
        final QueueSynchronizedTest24 s = new QueueSynchronizedTest24();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest24();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest24 s;
