...
import xxxx.foo.QueueSynchronizedTest66;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest66_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest66_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest66");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest66 t = new QueueSynchronizedTest66();
        final QueueSynchronizedTest66 s = new QueueSynchronizedTest66();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest66();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest66 s;
