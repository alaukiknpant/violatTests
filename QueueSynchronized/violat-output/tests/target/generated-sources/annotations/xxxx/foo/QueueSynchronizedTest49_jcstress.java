...
import xxxx.foo.QueueSynchronizedTest49;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest49_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest49_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest49");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest49 t = new QueueSynchronizedTest49();
        final QueueSynchronizedTest49 s = new QueueSynchronizedTest49();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest49();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest49 s;
