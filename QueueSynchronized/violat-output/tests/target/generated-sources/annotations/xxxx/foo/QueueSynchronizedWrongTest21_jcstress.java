...
import xxxx.foo.QueueSynchronizedWrongTest21;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedWrongTest21_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedWrongTest21_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest21");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest21 t = new QueueSynchronizedWrongTest21();
        final QueueSynchronizedWrongTest21 s = new QueueSynchronizedWrongTest21();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest21();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult0_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest21 s = p.s;
            p.s = new QueueSynchronizedWrongTest21();
            cnt.record(r);
        }
    }
    ...
    static class Pair {
        public QueueSynchronizedWrongTest21 s;
