...
import xxxx.foo.QueueSynchronizedTest23;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest23_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest23_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest23");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest23 t = new QueueSynchronizedTest23();
        final QueueSynchronizedTest23 s = new QueueSynchronizedTest23();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest23();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest23 s;
