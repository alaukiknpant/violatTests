...
import xxxx.foo.QueueSynchronizedTest78;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest78_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest78_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest78");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest78 t = new QueueSynchronizedTest78();
        final QueueSynchronizedTest78 s = new QueueSynchronizedTest78();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest78();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest78 s;
