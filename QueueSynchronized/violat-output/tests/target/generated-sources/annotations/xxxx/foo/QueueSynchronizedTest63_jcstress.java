...
import xxxx.foo.QueueSynchronizedTest63;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest63_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest63_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest63");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest63 t = new QueueSynchronizedTest63();
        final QueueSynchronizedTest63 s = new QueueSynchronizedTest63();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest63();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest63 s;
