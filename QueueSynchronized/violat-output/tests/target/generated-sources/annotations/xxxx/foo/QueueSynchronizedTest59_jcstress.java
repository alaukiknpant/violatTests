...
import xxxx.foo.QueueSynchronizedTest59;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedTest59_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedTest59_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest59");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest59 t = new QueueSynchronizedTest59();
        final QueueSynchronizedTest59 s = new QueueSynchronizedTest59();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest59();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest59 s;
