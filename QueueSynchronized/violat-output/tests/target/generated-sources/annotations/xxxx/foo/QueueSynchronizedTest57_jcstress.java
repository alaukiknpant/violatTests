...
import xxxx.foo.QueueSynchronizedTest57;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest57_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest57_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest57");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest57 t = new QueueSynchronizedTest57();
        final QueueSynchronizedTest57 s = new QueueSynchronizedTest57();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest57();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest57 s;
