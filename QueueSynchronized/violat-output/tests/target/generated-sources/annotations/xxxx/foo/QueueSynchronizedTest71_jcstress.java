...
import xxxx.foo.QueueSynchronizedTest71;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest71_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest71_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest71");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest71 t = new QueueSynchronizedTest71();
        final QueueSynchronizedTest71 s = new QueueSynchronizedTest71();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest71();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest71 s;
