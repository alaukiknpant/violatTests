...
import xxxx.foo.QueueSynchronizedTest33;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest33_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest33_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest33");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest33 t = new QueueSynchronizedTest33();
        final QueueSynchronizedTest33 s = new QueueSynchronizedTest33();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest33();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest33 s;
