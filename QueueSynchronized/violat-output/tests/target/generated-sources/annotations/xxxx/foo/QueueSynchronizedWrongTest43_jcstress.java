...
import xxxx.foo.QueueSynchronizedWrongTest43;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedWrongTest43_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedWrongTest43_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest43");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest43 t = new QueueSynchronizedWrongTest43();
        final QueueSynchronizedWrongTest43 s = new QueueSynchronizedWrongTest43();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest43();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult1_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest43 s = p.s;
            p.s = new QueueSynchronizedWrongTest43();
            cnt.record(r);
            r.r1 = null;
        }
    ...
    static class Pair {
        public QueueSynchronizedWrongTest43 s;
