...
import xxxx.foo.QueueSynchronizedWrongTest44;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedWrongTest44_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedWrongTest44_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest44");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest44 t = new QueueSynchronizedWrongTest44();
        final QueueSynchronizedWrongTest44 s = new QueueSynchronizedWrongTest44();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest44();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult0_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest44 s = p.s;
            p.s = new QueueSynchronizedWrongTest44();
            cnt.record(r);
        }
    }
    ...
    static class Pair {
        public QueueSynchronizedWrongTest44 s;
