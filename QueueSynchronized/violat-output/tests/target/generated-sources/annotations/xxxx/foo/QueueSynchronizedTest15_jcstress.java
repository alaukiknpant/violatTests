...
import xxxx.foo.QueueSynchronizedTest15;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest15_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest15_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest15");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest15 t = new QueueSynchronizedTest15();
        final QueueSynchronizedTest15 s = new QueueSynchronizedTest15();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest15();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest15 s;
