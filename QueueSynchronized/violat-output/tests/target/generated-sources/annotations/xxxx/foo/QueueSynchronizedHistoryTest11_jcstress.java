...
import xxxx.foo.QueueSynchronizedHistoryTest11;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedHistoryTest11_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedHistoryTest11_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedHistoryTest11");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedHistoryTest11 t = new QueueSynchronizedHistoryTest11();
        final QueueSynchronizedHistoryTest11 s = new QueueSynchronizedHistoryTest11();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedHistoryTest11();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
                p.s.actor2(p.r);
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult3_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedHistoryTest11 s = p.s;
            p.s = new QueueSynchronizedHistoryTest11();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedHistoryTest11 s;
