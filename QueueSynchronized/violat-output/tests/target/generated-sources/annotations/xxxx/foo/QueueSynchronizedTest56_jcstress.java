...
import xxxx.foo.QueueSynchronizedTest56;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest56_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest56_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest56");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest56 t = new QueueSynchronizedTest56();
        final QueueSynchronizedTest56 s = new QueueSynchronizedTest56();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest56();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest56 s;
