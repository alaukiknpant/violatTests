...
import xxxx.foo.QueueSynchronizedTest12;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest12_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest12_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest12");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest12 t = new QueueSynchronizedTest12();
        final QueueSynchronizedTest12 s = new QueueSynchronizedTest12();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest12();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest12 s;
