...
import xxxx.foo.QueueSynchronizedTest3;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest3_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest3_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest3");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest3 t = new QueueSynchronizedTest3();
        final QueueSynchronizedTest3 s = new QueueSynchronizedTest3();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest3();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest3 s;
