...
import xxxx.foo.QueueSynchronizedHistoryTest4;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedHistoryTest4_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedHistoryTest4_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedHistoryTest4");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedHistoryTest4 t = new QueueSynchronizedHistoryTest4();
        final QueueSynchronizedHistoryTest4 s = new QueueSynchronizedHistoryTest4();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedHistoryTest4();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult2_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedHistoryTest4 s = p.s;
            p.s = new QueueSynchronizedHistoryTest4();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedHistoryTest4 s;
