...
import xxxx.foo.QueueSynchronizedTest20;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest20_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest20_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest20");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest20 t = new QueueSynchronizedTest20();
        final QueueSynchronizedTest20 s = new QueueSynchronizedTest20();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest20();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest20 s;
