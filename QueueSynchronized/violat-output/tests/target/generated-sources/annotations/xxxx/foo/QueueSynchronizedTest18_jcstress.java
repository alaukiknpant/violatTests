...
import xxxx.foo.QueueSynchronizedTest18;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest18_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest18_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest18");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest18 t = new QueueSynchronizedTest18();
        final QueueSynchronizedTest18 s = new QueueSynchronizedTest18();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest18();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest18 s;
