...
import xxxx.foo.QueueSynchronizedTest76;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest76_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest76_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest76");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest76 t = new QueueSynchronizedTest76();
        final QueueSynchronizedTest76 s = new QueueSynchronizedTest76();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest76();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest76 s;
