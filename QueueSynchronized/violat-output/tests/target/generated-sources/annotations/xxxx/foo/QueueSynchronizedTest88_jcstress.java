...
import xxxx.foo.QueueSynchronizedTest88;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest88_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest88_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest88");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest88 t = new QueueSynchronizedTest88();
        final QueueSynchronizedTest88 s = new QueueSynchronizedTest88();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest88();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest88 s;
