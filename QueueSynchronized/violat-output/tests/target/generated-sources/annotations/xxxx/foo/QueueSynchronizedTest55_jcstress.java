...
import xxxx.foo.QueueSynchronizedTest55;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest55_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest55_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest55");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest55 t = new QueueSynchronizedTest55();
        final QueueSynchronizedTest55 s = new QueueSynchronizedTest55();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest55();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest55 s;
