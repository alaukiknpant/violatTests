...
import xxxx.foo.QueueSynchronizedTest1;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest1_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest1_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest1");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest1 t = new QueueSynchronizedTest1();
        final QueueSynchronizedTest1 s = new QueueSynchronizedTest1();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest1();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest1 s;
