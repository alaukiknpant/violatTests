...
import xxxx.foo.QueueSynchronizedTest58;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest58_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest58_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest58");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest58 t = new QueueSynchronizedTest58();
        final QueueSynchronizedTest58 s = new QueueSynchronizedTest58();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest58();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest58 s;
