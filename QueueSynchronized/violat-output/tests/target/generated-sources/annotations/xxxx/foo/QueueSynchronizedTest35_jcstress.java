...
import xxxx.foo.QueueSynchronizedTest35;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest35_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest35_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest35");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest35 t = new QueueSynchronizedTest35();
        final QueueSynchronizedTest35 s = new QueueSynchronizedTest35();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest35();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest35 s;
