...
import xxxx.foo.QueueSynchronizedTest95;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest95_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest95_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest95");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest95 t = new QueueSynchronizedTest95();
        final QueueSynchronizedTest95 s = new QueueSynchronizedTest95();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest95();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest95 s;
