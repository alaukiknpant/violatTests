...
import xxxx.foo.QueueSynchronizedTest53;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest53_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest53_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest53");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest53 t = new QueueSynchronizedTest53();
        final QueueSynchronizedTest53 s = new QueueSynchronizedTest53();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest53();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest53 s;
