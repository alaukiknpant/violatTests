...
import xxxx.foo.QueueSynchronizedTest90;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest90_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest90_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest90");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest90 t = new QueueSynchronizedTest90();
        final QueueSynchronizedTest90 s = new QueueSynchronizedTest90();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest90();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest90 s;
