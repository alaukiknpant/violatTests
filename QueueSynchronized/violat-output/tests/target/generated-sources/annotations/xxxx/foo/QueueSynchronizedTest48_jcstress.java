...
import xxxx.foo.QueueSynchronizedTest48;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest48_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest48_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest48");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest48 t = new QueueSynchronizedTest48();
        final QueueSynchronizedTest48 s = new QueueSynchronizedTest48();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest48();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest48 s;
