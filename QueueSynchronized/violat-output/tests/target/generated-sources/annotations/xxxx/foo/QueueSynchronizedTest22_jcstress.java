...
import xxxx.foo.QueueSynchronizedTest22;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest22_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest22_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest22");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest22 t = new QueueSynchronizedTest22();
        final QueueSynchronizedTest22 s = new QueueSynchronizedTest22();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest22();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest22 s;
