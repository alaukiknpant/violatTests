...
import xxxx.foo.QueueSynchronizedWrongTest38;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedWrongTest38_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedWrongTest38_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest38");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest38 t = new QueueSynchronizedWrongTest38();
        final QueueSynchronizedWrongTest38 s = new QueueSynchronizedWrongTest38();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest38();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult3_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest38 s = p.s;
            p.s = new QueueSynchronizedWrongTest38();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedWrongTest38 s;
