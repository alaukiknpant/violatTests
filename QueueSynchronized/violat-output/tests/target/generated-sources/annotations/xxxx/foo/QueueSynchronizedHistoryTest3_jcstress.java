...
import xxxx.foo.QueueSynchronizedHistoryTest3;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueSynchronizedHistoryTest3_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueSynchronizedHistoryTest3_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedHistoryTest3");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedHistoryTest3 t = new QueueSynchronizedHistoryTest3();
        final QueueSynchronizedHistoryTest3 s = new QueueSynchronizedHistoryTest3();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedHistoryTest3();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
                p.s.actor2(p.r);
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult4_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedHistoryTest3 s = p.s;
            p.s = new QueueSynchronizedHistoryTest3();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedHistoryTest3 s;
