...
import xxxx.foo.QueueSynchronizedTest85;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest85_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest85_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest85");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest85 t = new QueueSynchronizedTest85();
        final QueueSynchronizedTest85 s = new QueueSynchronizedTest85();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest85();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest85 s;
