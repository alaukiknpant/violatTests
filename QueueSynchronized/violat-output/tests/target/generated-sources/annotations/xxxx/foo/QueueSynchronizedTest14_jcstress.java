...
import xxxx.foo.QueueSynchronizedTest14;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest14_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest14_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest14");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest14 t = new QueueSynchronizedTest14();
        final QueueSynchronizedTest14 s = new QueueSynchronizedTest14();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest14();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest14 s;
