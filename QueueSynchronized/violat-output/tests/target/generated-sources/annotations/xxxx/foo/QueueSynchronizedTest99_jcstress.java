...
import xxxx.foo.QueueSynchronizedTest99;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest99_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest99_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest99");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest99 t = new QueueSynchronizedTest99();
        final QueueSynchronizedTest99 s = new QueueSynchronizedTest99();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest99();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest99 s;
