...
import xxxx.foo.QueueSynchronizedTest87;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest87_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest87_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest87");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest87 t = new QueueSynchronizedTest87();
        final QueueSynchronizedTest87 s = new QueueSynchronizedTest87();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest87();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest87 s;
