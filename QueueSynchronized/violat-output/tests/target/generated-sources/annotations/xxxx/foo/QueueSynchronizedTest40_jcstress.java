...
import xxxx.foo.QueueSynchronizedTest40;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest40_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest40_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest40");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest40 t = new QueueSynchronizedTest40();
        final QueueSynchronizedTest40 s = new QueueSynchronizedTest40();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest40();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest40 s;
