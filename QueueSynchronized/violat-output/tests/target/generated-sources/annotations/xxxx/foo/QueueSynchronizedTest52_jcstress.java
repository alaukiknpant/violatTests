...
import xxxx.foo.QueueSynchronizedTest52;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest52_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest52_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest52");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest52 t = new QueueSynchronizedTest52();
        final QueueSynchronizedTest52 s = new QueueSynchronizedTest52();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest52();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest52 s;
