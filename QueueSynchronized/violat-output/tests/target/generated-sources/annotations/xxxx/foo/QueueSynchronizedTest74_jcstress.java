...
import xxxx.foo.QueueSynchronizedTest74;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest74_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest74_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest74");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest74 t = new QueueSynchronizedTest74();
        final QueueSynchronizedTest74 s = new QueueSynchronizedTest74();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest74();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest74 s;
