...
import xxxx.foo.QueueSynchronizedHistoryTest8;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedHistoryTest8_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedHistoryTest8_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedHistoryTest8");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedHistoryTest8 t = new QueueSynchronizedHistoryTest8();
        final QueueSynchronizedHistoryTest8 s = new QueueSynchronizedHistoryTest8();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedHistoryTest8();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult2_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedHistoryTest8 s = p.s;
            p.s = new QueueSynchronizedHistoryTest8();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedHistoryTest8 s;
