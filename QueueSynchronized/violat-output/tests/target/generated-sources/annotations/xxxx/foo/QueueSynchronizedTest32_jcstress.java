...
import xxxx.foo.QueueSynchronizedTest32;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest32_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest32_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest32");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest32 t = new QueueSynchronizedTest32();
        final QueueSynchronizedTest32 s = new QueueSynchronizedTest32();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest32();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest32 s;
