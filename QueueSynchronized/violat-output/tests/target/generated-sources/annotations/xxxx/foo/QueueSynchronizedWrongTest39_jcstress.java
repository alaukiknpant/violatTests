...
import xxxx.foo.QueueSynchronizedWrongTest39;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueSynchronizedWrongTest39_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueSynchronizedWrongTest39_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest39");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest39 t = new QueueSynchronizedWrongTest39();
        final QueueSynchronizedWrongTest39 s = new QueueSynchronizedWrongTest39();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest39();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult4_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest39 s = p.s;
            p.s = new QueueSynchronizedWrongTest39();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedWrongTest39 s;
