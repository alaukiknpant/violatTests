...
import xxxx.foo.QueueSynchronizedHistoryTest2;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueSynchronizedHistoryTest2_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueSynchronizedHistoryTest2_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedHistoryTest2");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedHistoryTest2 t = new QueueSynchronizedHistoryTest2();
        final QueueSynchronizedHistoryTest2 s = new QueueSynchronizedHistoryTest2();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedHistoryTest2();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
                p.s.actor2(p.r);
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult4_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedHistoryTest2 s = p.s;
            p.s = new QueueSynchronizedHistoryTest2();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedHistoryTest2 s;
