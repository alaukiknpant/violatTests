...
import xxxx.foo.QueueSynchronizedTest28;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedTest28_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedTest28_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest28");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest28 t = new QueueSynchronizedTest28();
        final QueueSynchronizedTest28 s = new QueueSynchronizedTest28();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest28();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest28 s;
