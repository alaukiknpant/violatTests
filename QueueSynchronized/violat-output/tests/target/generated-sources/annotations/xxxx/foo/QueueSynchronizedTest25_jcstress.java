...
import xxxx.foo.QueueSynchronizedTest25;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest25_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest25_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest25");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest25 t = new QueueSynchronizedTest25();
        final QueueSynchronizedTest25 s = new QueueSynchronizedTest25();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest25();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest25 s;
