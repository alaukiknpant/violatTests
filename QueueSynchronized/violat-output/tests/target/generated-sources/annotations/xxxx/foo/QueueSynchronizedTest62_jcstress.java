...
import xxxx.foo.QueueSynchronizedTest62;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest62_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest62_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest62");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest62 t = new QueueSynchronizedTest62();
        final QueueSynchronizedTest62 s = new QueueSynchronizedTest62();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest62();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest62 s;
