...
import xxxx.foo.QueueSynchronizedTest6;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest6_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest6_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest6");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest6 t = new QueueSynchronizedTest6();
        final QueueSynchronizedTest6 s = new QueueSynchronizedTest6();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest6();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest6 s;
