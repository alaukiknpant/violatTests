...
import xxxx.foo.QueueSynchronizedTest67;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest67_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest67_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest67");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest67 t = new QueueSynchronizedTest67();
        final QueueSynchronizedTest67 s = new QueueSynchronizedTest67();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest67();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest67 s;
