...
import xxxx.foo.QueueSynchronizedTest91;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest91_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest91_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest91");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest91 t = new QueueSynchronizedTest91();
        final QueueSynchronizedTest91 s = new QueueSynchronizedTest91();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest91();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest91 s;
