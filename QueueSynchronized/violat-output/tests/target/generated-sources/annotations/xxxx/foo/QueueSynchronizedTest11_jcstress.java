...
import xxxx.foo.QueueSynchronizedTest11;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest11_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest11_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest11");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest11 t = new QueueSynchronizedTest11();
        final QueueSynchronizedTest11 s = new QueueSynchronizedTest11();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest11();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest11 s;
