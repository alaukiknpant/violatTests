...
import xxxx.foo.QueueSynchronizedTest79;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest79_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest79_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest79");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest79 t = new QueueSynchronizedTest79();
        final QueueSynchronizedTest79 s = new QueueSynchronizedTest79();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest79();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest79 s;
