...
import xxxx.foo.QueueSynchronizedTest89;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest89_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest89_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest89");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest89 t = new QueueSynchronizedTest89();
        final QueueSynchronizedTest89 s = new QueueSynchronizedTest89();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest89();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest89 s;
