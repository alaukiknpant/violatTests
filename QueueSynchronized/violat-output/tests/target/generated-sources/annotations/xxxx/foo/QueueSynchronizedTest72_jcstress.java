...
import xxxx.foo.QueueSynchronizedTest72;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest72_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest72_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest72");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest72 t = new QueueSynchronizedTest72();
        final QueueSynchronizedTest72 s = new QueueSynchronizedTest72();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest72();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest72 s;
