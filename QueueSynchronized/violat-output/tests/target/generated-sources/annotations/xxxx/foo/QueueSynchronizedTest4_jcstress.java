...
import xxxx.foo.QueueSynchronizedTest4;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest4_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest4_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest4");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest4 t = new QueueSynchronizedTest4();
        final QueueSynchronizedTest4 s = new QueueSynchronizedTest4();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest4();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest4 s;
