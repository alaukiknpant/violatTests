...
import xxxx.foo.QueueSynchronizedTest2;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest2_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest2_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest2");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest2 t = new QueueSynchronizedTest2();
        final QueueSynchronizedTest2 s = new QueueSynchronizedTest2();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest2();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest2 s;
