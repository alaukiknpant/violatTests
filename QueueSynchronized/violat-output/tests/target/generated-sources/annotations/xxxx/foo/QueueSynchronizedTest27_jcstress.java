...
import xxxx.foo.QueueSynchronizedTest27;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest27_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest27_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest27");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest27 t = new QueueSynchronizedTest27();
        final QueueSynchronizedTest27 s = new QueueSynchronizedTest27();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest27();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest27 s;
