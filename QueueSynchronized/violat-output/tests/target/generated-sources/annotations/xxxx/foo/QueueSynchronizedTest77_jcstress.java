...
import xxxx.foo.QueueSynchronizedTest77;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest77_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest77_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest77");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest77 t = new QueueSynchronizedTest77();
        final QueueSynchronizedTest77 s = new QueueSynchronizedTest77();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest77();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest77 s;
