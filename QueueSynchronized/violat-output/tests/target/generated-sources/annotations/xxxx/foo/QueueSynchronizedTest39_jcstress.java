...
import xxxx.foo.QueueSynchronizedTest39;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueSynchronizedTest39_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueSynchronizedTest39_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest39");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest39 t = new QueueSynchronizedTest39();
        final QueueSynchronizedTest39 s = new QueueSynchronizedTest39();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest39();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest39 s;
