...
import xxxx.foo.QueueSynchronizedTest10;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest10_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest10_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest10");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest10 t = new QueueSynchronizedTest10();
        final QueueSynchronizedTest10 s = new QueueSynchronizedTest10();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest10();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest10 s;
