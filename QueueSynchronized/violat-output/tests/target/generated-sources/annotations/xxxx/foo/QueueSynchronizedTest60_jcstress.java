...
import xxxx.foo.QueueSynchronizedTest60;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest60_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest60_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest60");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest60 t = new QueueSynchronizedTest60();
        final QueueSynchronizedTest60 s = new QueueSynchronizedTest60();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest60();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest60 s;
