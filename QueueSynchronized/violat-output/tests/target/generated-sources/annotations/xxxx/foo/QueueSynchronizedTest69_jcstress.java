...
import xxxx.foo.QueueSynchronizedTest69;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest69_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest69_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest69");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest69 t = new QueueSynchronizedTest69();
        final QueueSynchronizedTest69 s = new QueueSynchronizedTest69();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest69();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest69 s;
