...
import xxxx.foo.QueueSynchronizedWrongTest52;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedWrongTest52_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedWrongTest52_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest52");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest52 t = new QueueSynchronizedWrongTest52();
        final QueueSynchronizedWrongTest52 s = new QueueSynchronizedWrongTest52();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest52();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult0_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest52 s = p.s;
            p.s = new QueueSynchronizedWrongTest52();
            cnt.record(r);
        }
    }
    ...
    static class Pair {
        public QueueSynchronizedWrongTest52 s;
