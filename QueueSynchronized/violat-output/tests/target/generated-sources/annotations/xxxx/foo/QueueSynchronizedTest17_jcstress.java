...
import xxxx.foo.QueueSynchronizedTest17;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedTest17_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedTest17_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest17");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest17 t = new QueueSynchronizedTest17();
        final QueueSynchronizedTest17 s = new QueueSynchronizedTest17();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest17();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest17 s;
