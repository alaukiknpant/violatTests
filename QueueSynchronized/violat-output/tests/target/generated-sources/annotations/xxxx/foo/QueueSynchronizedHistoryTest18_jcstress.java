...
import xxxx.foo.QueueSynchronizedHistoryTest18;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedHistoryTest18_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedHistoryTest18_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedHistoryTest18");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedHistoryTest18 t = new QueueSynchronizedHistoryTest18();
        final QueueSynchronizedHistoryTest18 s = new QueueSynchronizedHistoryTest18();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedHistoryTest18();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult2_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedHistoryTest18 s = p.s;
            p.s = new QueueSynchronizedHistoryTest18();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedHistoryTest18 s;
