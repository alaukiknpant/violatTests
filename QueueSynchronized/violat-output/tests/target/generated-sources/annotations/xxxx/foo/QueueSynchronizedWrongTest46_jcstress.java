...
import xxxx.foo.QueueSynchronizedWrongTest46;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedWrongTest46_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedWrongTest46_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest46");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest46 t = new QueueSynchronizedWrongTest46();
        final QueueSynchronizedWrongTest46 s = new QueueSynchronizedWrongTest46();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest46();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult0_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest46 s = p.s;
            p.s = new QueueSynchronizedWrongTest46();
            cnt.record(r);
        }
    }
    ...
    static class Pair {
        public QueueSynchronizedWrongTest46 s;
