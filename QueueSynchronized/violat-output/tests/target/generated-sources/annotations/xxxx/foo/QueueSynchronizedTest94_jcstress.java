...
import xxxx.foo.QueueSynchronizedTest94;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest94_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest94_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest94");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest94 t = new QueueSynchronizedTest94();
        final QueueSynchronizedTest94 s = new QueueSynchronizedTest94();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest94();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest94 s;
