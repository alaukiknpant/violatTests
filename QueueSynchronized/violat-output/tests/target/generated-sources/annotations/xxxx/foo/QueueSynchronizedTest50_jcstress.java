...
import xxxx.foo.QueueSynchronizedTest50;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest50_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest50_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest50");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest50 t = new QueueSynchronizedTest50();
        final QueueSynchronizedTest50 s = new QueueSynchronizedTest50();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest50();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest50 s;
