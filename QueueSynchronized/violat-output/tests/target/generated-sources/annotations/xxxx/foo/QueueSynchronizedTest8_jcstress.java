...
import xxxx.foo.QueueSynchronizedTest8;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest8_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest8_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest8");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest8 t = new QueueSynchronizedTest8();
        final QueueSynchronizedTest8 s = new QueueSynchronizedTest8();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest8();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest8 s;
