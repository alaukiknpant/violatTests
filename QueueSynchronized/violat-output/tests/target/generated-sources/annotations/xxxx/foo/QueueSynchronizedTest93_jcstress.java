...
import xxxx.foo.QueueSynchronizedTest93;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest93_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest93_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest93");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest93 t = new QueueSynchronizedTest93();
        final QueueSynchronizedTest93 s = new QueueSynchronizedTest93();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest93();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest93 s;
