...
import xxxx.foo.QueueSynchronizedWrongTest59;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedWrongTest59_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedWrongTest59_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest59");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest59 t = new QueueSynchronizedWrongTest59();
        final QueueSynchronizedWrongTest59 s = new QueueSynchronizedWrongTest59();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest59();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult3_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest59 s = p.s;
            p.s = new QueueSynchronizedWrongTest59();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedWrongTest59 s;
