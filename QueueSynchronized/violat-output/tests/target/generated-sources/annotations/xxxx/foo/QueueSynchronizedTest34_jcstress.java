...
import xxxx.foo.QueueSynchronizedTest34;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest34_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest34_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest34");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest34 t = new QueueSynchronizedTest34();
        final QueueSynchronizedTest34 s = new QueueSynchronizedTest34();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest34();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest34 s;
