...
import xxxx.foo.QueueSynchronizedTest16;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueSynchronizedTest16_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueSynchronizedTest16_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest16");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest16 t = new QueueSynchronizedTest16();
        final QueueSynchronizedTest16 s = new QueueSynchronizedTest16();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest16();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest16 s;
