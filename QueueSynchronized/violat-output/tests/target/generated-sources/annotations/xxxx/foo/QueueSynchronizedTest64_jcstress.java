...
import xxxx.foo.QueueSynchronizedTest64;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest64_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest64_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest64");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest64 t = new QueueSynchronizedTest64();
        final QueueSynchronizedTest64 s = new QueueSynchronizedTest64();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest64();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest64 s;
