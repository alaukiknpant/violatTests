...
import xxxx.foo.QueueSynchronizedTest29;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest29_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest29_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest29");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest29 t = new QueueSynchronizedTest29();
        final QueueSynchronizedTest29 s = new QueueSynchronizedTest29();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest29();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest29 s;
