...
import xxxx.foo.QueueSynchronizedTest82;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedTest82_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedTest82_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest82");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest82 t = new QueueSynchronizedTest82();
        final QueueSynchronizedTest82 s = new QueueSynchronizedTest82();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest82();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest82 s;
