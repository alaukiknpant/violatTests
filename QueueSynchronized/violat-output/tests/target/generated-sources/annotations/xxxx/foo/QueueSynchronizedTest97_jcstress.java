...
import xxxx.foo.QueueSynchronizedTest97;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest97_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest97_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest97");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest97 t = new QueueSynchronizedTest97();
        final QueueSynchronizedTest97 s = new QueueSynchronizedTest97();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest97();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest97 s;
