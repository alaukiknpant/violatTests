...
import xxxx.foo.QueueSynchronizedTest83;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest83_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest83_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest83");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest83 t = new QueueSynchronizedTest83();
        final QueueSynchronizedTest83 s = new QueueSynchronizedTest83();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest83();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest83 s;
