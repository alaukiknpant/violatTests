...
import xxxx.foo.QueueSynchronizedTest86;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest86_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest86_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest86");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest86 t = new QueueSynchronizedTest86();
        final QueueSynchronizedTest86 s = new QueueSynchronizedTest86();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest86();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest86 s;
