...
import xxxx.foo.QueueSynchronizedWrongTest78;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedWrongTest78_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedWrongTest78_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest78");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest78 t = new QueueSynchronizedWrongTest78();
        final QueueSynchronizedWrongTest78 s = new QueueSynchronizedWrongTest78();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest78();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult0_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest78 s = p.s;
            p.s = new QueueSynchronizedWrongTest78();
            cnt.record(r);
        }
    }
    ...
    static class Pair {
        public QueueSynchronizedWrongTest78 s;
