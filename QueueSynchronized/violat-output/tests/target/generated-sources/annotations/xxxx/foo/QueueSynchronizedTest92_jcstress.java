...
import xxxx.foo.QueueSynchronizedTest92;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest92_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest92_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest92");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest92 t = new QueueSynchronizedTest92();
        final QueueSynchronizedTest92 s = new QueueSynchronizedTest92();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest92();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest92 s;
