...
import xxxx.foo.QueueSynchronizedTest65;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest65_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest65_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest65");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest65 t = new QueueSynchronizedTest65();
        final QueueSynchronizedTest65 s = new QueueSynchronizedTest65();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest65();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest65 s;
