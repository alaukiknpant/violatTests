...
import xxxx.foo.QueueSynchronizedWrongTest13;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedWrongTest13_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedWrongTest13_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest13");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest13 t = new QueueSynchronizedWrongTest13();
        final QueueSynchronizedWrongTest13 s = new QueueSynchronizedWrongTest13();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest13();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult2_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest13 s = p.s;
            p.s = new QueueSynchronizedWrongTest13();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedWrongTest13 s;
