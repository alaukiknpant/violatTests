...
import xxxx.foo.QueueSynchronizedWrongTest63;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedWrongTest63_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedWrongTest63_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest63");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest63 t = new QueueSynchronizedWrongTest63();
        final QueueSynchronizedWrongTest63 s = new QueueSynchronizedWrongTest63();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest63();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult2_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest63 s = p.s;
            p.s = new QueueSynchronizedWrongTest63();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedWrongTest63 s;
