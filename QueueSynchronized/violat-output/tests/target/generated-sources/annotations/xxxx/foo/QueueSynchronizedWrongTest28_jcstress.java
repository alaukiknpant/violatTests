...
import xxxx.foo.QueueSynchronizedWrongTest28;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedWrongTest28_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedWrongTest28_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest28");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest28 t = new QueueSynchronizedWrongTest28();
        final QueueSynchronizedWrongTest28 s = new QueueSynchronizedWrongTest28();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest28();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult3_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest28 s = p.s;
            p.s = new QueueSynchronizedWrongTest28();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedWrongTest28 s;
