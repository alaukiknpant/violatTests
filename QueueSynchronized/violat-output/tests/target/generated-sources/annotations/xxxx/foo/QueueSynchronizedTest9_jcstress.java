...
import xxxx.foo.QueueSynchronizedTest9;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest9_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest9_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest9");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest9 t = new QueueSynchronizedTest9();
        final QueueSynchronizedTest9 s = new QueueSynchronizedTest9();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest9();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest9 s;
