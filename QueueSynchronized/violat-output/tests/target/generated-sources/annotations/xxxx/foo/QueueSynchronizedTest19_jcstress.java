...
import xxxx.foo.QueueSynchronizedTest19;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest19_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest19_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest19");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest19 t = new QueueSynchronizedTest19();
        final QueueSynchronizedTest19 s = new QueueSynchronizedTest19();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest19();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest19 s;
