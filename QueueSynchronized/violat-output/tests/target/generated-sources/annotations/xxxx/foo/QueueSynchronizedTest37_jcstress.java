...
import xxxx.foo.QueueSynchronizedTest37;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest37_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest37_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest37");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest37 t = new QueueSynchronizedTest37();
        final QueueSynchronizedTest37 s = new QueueSynchronizedTest37();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest37();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest37 s;
