...
import xxxx.foo.QueueSynchronizedTest46;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest46_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest46_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest46");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest46 t = new QueueSynchronizedTest46();
        final QueueSynchronizedTest46 s = new QueueSynchronizedTest46();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest46();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest46 s;
