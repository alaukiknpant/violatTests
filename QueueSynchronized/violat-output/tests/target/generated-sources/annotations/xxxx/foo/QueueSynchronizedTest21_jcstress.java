...
import xxxx.foo.QueueSynchronizedTest21;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest21_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest21_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest21");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest21 t = new QueueSynchronizedTest21();
        final QueueSynchronizedTest21 s = new QueueSynchronizedTest21();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest21();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest21 s;
