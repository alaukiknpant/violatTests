...
import xxxx.foo.QueueSynchronizedTest70;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest70_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest70_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest70");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest70 t = new QueueSynchronizedTest70();
        final QueueSynchronizedTest70 s = new QueueSynchronizedTest70();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest70();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest70 s;
