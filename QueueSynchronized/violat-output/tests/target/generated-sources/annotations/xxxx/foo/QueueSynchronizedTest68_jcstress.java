...
import xxxx.foo.QueueSynchronizedTest68;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest68_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest68_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest68");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest68 t = new QueueSynchronizedTest68();
        final QueueSynchronizedTest68 s = new QueueSynchronizedTest68();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest68();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest68 s;
