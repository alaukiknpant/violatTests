...
import xxxx.foo.QueueSynchronizedTest43;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest43_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest43_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest43");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest43 t = new QueueSynchronizedTest43();
        final QueueSynchronizedTest43 s = new QueueSynchronizedTest43();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest43();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest43 s;
