...
import xxxx.foo.QueueSynchronizedTest7;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest7_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest7_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest7");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest7 t = new QueueSynchronizedTest7();
        final QueueSynchronizedTest7 s = new QueueSynchronizedTest7();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest7();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest7 s;
