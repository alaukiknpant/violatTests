...
import xxxx.foo.QueueSynchronizedTest73;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest73_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest73_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest73");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest73 t = new QueueSynchronizedTest73();
        final QueueSynchronizedTest73 s = new QueueSynchronizedTest73();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest73();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest73 s;
