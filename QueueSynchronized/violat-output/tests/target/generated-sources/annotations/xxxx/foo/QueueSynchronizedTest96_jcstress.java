...
import xxxx.foo.QueueSynchronizedTest96;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest96_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest96_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest96");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest96 t = new QueueSynchronizedTest96();
        final QueueSynchronizedTest96 s = new QueueSynchronizedTest96();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest96();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest96 s;
