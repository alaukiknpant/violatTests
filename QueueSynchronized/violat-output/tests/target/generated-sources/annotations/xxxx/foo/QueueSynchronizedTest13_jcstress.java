...
import xxxx.foo.QueueSynchronizedTest13;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest13_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest13_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest13");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest13 t = new QueueSynchronizedTest13();
        final QueueSynchronizedTest13 s = new QueueSynchronizedTest13();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest13();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest13 s;
