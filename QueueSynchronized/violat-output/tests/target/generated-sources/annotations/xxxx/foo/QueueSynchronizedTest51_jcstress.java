...
import xxxx.foo.QueueSynchronizedTest51;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest51_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest51_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest51");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest51 t = new QueueSynchronizedTest51();
        final QueueSynchronizedTest51 s = new QueueSynchronizedTest51();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest51();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest51 s;
