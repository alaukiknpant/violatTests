...
import xxxx.foo.QueueSynchronizedTest54;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest54_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest54_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest54");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest54 t = new QueueSynchronizedTest54();
        final QueueSynchronizedTest54 s = new QueueSynchronizedTest54();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest54();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest54 s;
