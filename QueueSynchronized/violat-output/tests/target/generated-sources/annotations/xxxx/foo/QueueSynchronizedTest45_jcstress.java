...
import xxxx.foo.QueueSynchronizedTest45;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest45_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest45_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest45");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest45 t = new QueueSynchronizedTest45();
        final QueueSynchronizedTest45 s = new QueueSynchronizedTest45();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest45();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest45 s;
