...
import xxxx.foo.QueueSynchronizedTest41;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest41_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest41_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest41");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest41 t = new QueueSynchronizedTest41();
        final QueueSynchronizedTest41 s = new QueueSynchronizedTest41();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest41();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest41 s;
