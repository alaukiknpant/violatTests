...
import xxxx.foo.QueueSynchronizedTest61;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest61_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest61_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest61");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest61 t = new QueueSynchronizedTest61();
        final QueueSynchronizedTest61 s = new QueueSynchronizedTest61();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest61();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest61 s;
