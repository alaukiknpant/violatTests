...
import xxxx.foo.QueueSynchronizedTest30;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedTest30_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedTest30_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest30");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest30 t = new QueueSynchronizedTest30();
        final QueueSynchronizedTest30 s = new QueueSynchronizedTest30();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest30();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest30 s;
