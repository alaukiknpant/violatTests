...
import xxxx.foo.QueueSynchronizedTest47;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest47_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest47_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest47");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest47 t = new QueueSynchronizedTest47();
        final QueueSynchronizedTest47 s = new QueueSynchronizedTest47();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest47();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest47 s;
