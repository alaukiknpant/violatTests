...
import xxxx.foo.QueueSynchronizedHistoryTest15;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedHistoryTest15_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedHistoryTest15_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedHistoryTest15");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedHistoryTest15 t = new QueueSynchronizedHistoryTest15();
        final QueueSynchronizedHistoryTest15 s = new QueueSynchronizedHistoryTest15();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedHistoryTest15();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
                p.s.actor2(p.r);
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult3_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedHistoryTest15 s = p.s;
            p.s = new QueueSynchronizedHistoryTest15();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedHistoryTest15 s;
