...
import xxxx.foo.QueueSynchronizedTest0;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest0_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest0_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest0");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest0 t = new QueueSynchronizedTest0();
        final QueueSynchronizedTest0 s = new QueueSynchronizedTest0();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest0();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest0 s;
