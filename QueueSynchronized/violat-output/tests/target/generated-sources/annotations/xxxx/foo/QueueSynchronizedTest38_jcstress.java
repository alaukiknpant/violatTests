...
import xxxx.foo.QueueSynchronizedTest38;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueSynchronizedTest38_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueSynchronizedTest38_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest38");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest38 t = new QueueSynchronizedTest38();
        final QueueSynchronizedTest38 s = new QueueSynchronizedTest38();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest38();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest38 s;
