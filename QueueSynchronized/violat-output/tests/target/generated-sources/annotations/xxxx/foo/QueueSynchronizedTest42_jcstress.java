...
import xxxx.foo.QueueSynchronizedTest42;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest42_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest42_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest42");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest42 t = new QueueSynchronizedTest42();
        final QueueSynchronizedTest42 s = new QueueSynchronizedTest42();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest42();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest42 s;
