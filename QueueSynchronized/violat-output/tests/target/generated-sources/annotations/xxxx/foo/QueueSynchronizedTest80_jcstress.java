...
import xxxx.foo.QueueSynchronizedTest80;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest80_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest80_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest80");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest80 t = new QueueSynchronizedTest80();
        final QueueSynchronizedTest80 s = new QueueSynchronizedTest80();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest80();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest80 s;
