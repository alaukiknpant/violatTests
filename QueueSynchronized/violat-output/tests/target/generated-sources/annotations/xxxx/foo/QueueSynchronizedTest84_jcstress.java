...
import xxxx.foo.QueueSynchronizedTest84;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest84_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest84_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest84");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest84 t = new QueueSynchronizedTest84();
        final QueueSynchronizedTest84 s = new QueueSynchronizedTest84();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest84();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest84 s;
