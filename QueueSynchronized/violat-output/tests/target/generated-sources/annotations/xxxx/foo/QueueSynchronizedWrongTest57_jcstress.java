...
import xxxx.foo.QueueSynchronizedWrongTest57;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedWrongTest57_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedWrongTest57_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest57");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest57 t = new QueueSynchronizedWrongTest57();
        final QueueSynchronizedWrongTest57 s = new QueueSynchronizedWrongTest57();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest57();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult2_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest57 s = p.s;
            p.s = new QueueSynchronizedWrongTest57();
            cnt.record(r);
            r.r1 = null;
            r.r2 = null;
    ...
    static class Pair {
        public QueueSynchronizedWrongTest57 s;
