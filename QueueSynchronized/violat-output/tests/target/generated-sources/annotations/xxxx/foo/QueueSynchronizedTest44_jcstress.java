...
import xxxx.foo.QueueSynchronizedTest44;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueSynchronizedTest44_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueSynchronizedTest44_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest44");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest44 t = new QueueSynchronizedTest44();
        final QueueSynchronizedTest44 s = new QueueSynchronizedTest44();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest44();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest44 s;
