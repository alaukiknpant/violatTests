...
import xxxx.foo.QueueSynchronizedTest31;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest31_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest31_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest31");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest31 t = new QueueSynchronizedTest31();
        final QueueSynchronizedTest31 s = new QueueSynchronizedTest31();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest31();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest31 s;
