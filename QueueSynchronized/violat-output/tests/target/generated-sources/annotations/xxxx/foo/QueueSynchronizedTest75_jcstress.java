...
import xxxx.foo.QueueSynchronizedTest75;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueSynchronizedTest75_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueSynchronizedTest75_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest75");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest75 t = new QueueSynchronizedTest75();
        final QueueSynchronizedTest75 s = new QueueSynchronizedTest75();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest75();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest75 s;
