...
import xxxx.foo.QueueSynchronizedTest36;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest36_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest36_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest36");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest36 t = new QueueSynchronizedTest36();
        final QueueSynchronizedTest36 s = new QueueSynchronizedTest36();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest36();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest36 s;
