...
import xxxx.foo.QueueSynchronizedWrongTest47;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedWrongTest47_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedWrongTest47_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedWrongTest47");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedWrongTest47 t = new QueueSynchronizedWrongTest47();
        final QueueSynchronizedWrongTest47 s = new QueueSynchronizedWrongTest47();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedWrongTest47();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    public final void jcstress_consume(StateHolder<Pair> holder, OpenAddressHashCounter<StringResult1_jcstress> cnt, int a, int actors) {
        ...
        for (int c = left; c < right; c++) {
            ...
            QueueSynchronizedWrongTest47 s = p.s;
            p.s = new QueueSynchronizedWrongTest47();
            cnt.record(r);
            r.r1 = null;
        }
    ...
    static class Pair {
        public QueueSynchronizedWrongTest47 s;
