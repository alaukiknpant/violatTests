...
import xxxx.foo.QueueSynchronizedTest81;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueSynchronizedTest81_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueSynchronizedTest81_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.foo.QueueSynchronizedTest81");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueSynchronizedTest81 t = new QueueSynchronizedTest81();
        final QueueSynchronizedTest81 s = new QueueSynchronizedTest81();
    ...
    private void sanityCheck_Footprints() throws Throwable {
        config.adjustStrides(size -> {
            ...
            for (int c = 0; c < size; c++) {
                ...
                p.s = new QueueSynchronizedTest81();
                version.pairs[c] = p;
                p.s.actor0(p.r);
                p.s.actor1(p.r);
            }
    ...
    static class Pair {
        public QueueSynchronizedTest81 s;
