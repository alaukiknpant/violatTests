...
@State
public class QueueSynchronizedHistoryTest15 {
    ...
    public void actor0(StringResult3 result) {
        ...
        result.r1 = "1@" + pcs[0][0] + ":" + "2@" + pcs[0][1] + "/" + "_" + ";" + "1@" + pcs[1][0] + ":" + "2@" + pcs[1][1] + "/" + "void" + ";" + "1@" + pcs[2][0] + ":" + "2@" + pcs[2][1] + "/" + "_" + ";" + "1@" + pcs[3][0] + ":" + "2@" + pcs[3][1] + "/" + r1;
    }
    ...
    public void actor1(StringResult3 result) {
        ...
        result.r2 = "0@" + pcs[0][0] + ":" + "2@" + pcs[0][1] + "/" + "_" + ";" + "0@" + pcs[1][0] + ":" + "2@" + pcs[1][1] + "/" + r0 + ";" + "0@" + pcs[2][0] + ":" + "2@" + pcs[2][1] + "/" + "_" + ";" + "0@" + pcs[3][0] + ":" + "2@" + pcs[3][1] + "/" + r1 + ";" + "0@" + pcs[4][0] + ":" + "2@" + pcs[4][1] + "/" + "_" + ";" + "0@" + pcs[5][0] + ":" + "2@" + pcs[5][1] + "/" + "void";
    }
    ...
    public void actor2(StringResult3 result) {
        ...
        try { pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); n++; pc2.increment(); r = ResultAdapter.get(obj.toString()); pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); n++; pc2.increment(); }
