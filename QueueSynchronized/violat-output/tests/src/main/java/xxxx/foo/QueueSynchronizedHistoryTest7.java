...
@State
public class QueueSynchronizedHistoryTest7 {
    ...
    public void actor0(StringResult4 result) {
        ...
        result.r1 = "1@" + pcs[0][0] + ":" + "2@" + pcs[0][1] + ":" + "3@" + pcs[0][2] + "/" + "_" + ";" + "1@" + pcs[1][0] + ":" + "2@" + pcs[1][1] + ":" + "3@" + pcs[1][2] + "/" + "void" + ";" + "1@" + pcs[2][0] + ":" + "2@" + pcs[2][1] + ":" + "3@" + pcs[2][2] + "/" + "_" + ";" + "1@" + pcs[3][0] + ":" + "2@" + pcs[3][1] + ":" + "3@" + pcs[3][2] + "/" + "void";
    }
    ...
    public void actor2(StringResult4 result) {
        ...
        try { pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc3.get(); n++; pc2.increment(); obj.put(0); pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc3.get(); n++; pc2.increment(); }
