...
@State
public class QueueSynchronizedHistoryTest3 {
    ...
    public void actor2(StringResult4 result) {
        ...
        result.r3 = "0@" + pcs[0][0] + ":" + "1@" + pcs[0][1] + ":" + "3@" + pcs[0][2] + "/" + "_" + ";" + "0@" + pcs[1][0] + ":" + "1@" + pcs[1][1] + ":" + "3@" + pcs[1][2] + "/" + "void" + ";" + "0@" + pcs[2][0] + ":" + "1@" + pcs[2][1] + ":" + "3@" + pcs[2][2] + "/" + "_" + ";" + "0@" + pcs[3][0] + ":" + "1@" + pcs[3][1] + ":" + "3@" + pcs[3][2] + "/" + "void";
    }
    ...
    public void actor3(StringResult4 result) {
        ...
        try { pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc2.get(); n++; pc3.increment(); obj.put(1); pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc2.get(); n++; pc3.increment(); }
        catch (Exception e) { pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc2.get(); n++; pc3.increment(); }
        
        try { pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc2.get(); n++; pc3.increment(); r = ResultAdapter.get(obj.get()); pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc2.get(); n++; pc3.increment(); }
        catch (Exception e) { pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc2.get(); n++; pc3.increment(); r = ResultAdapter.get(e); }
        r1 = r;
        
        result.r4 = "0@" + pcs[0][0] + ":" + "1@" + pcs[0][1] + ":" + "2@" + pcs[0][2] + "/" + "_" + ";" + "0@" + pcs[1][0] + ":" + "1@" + pcs[1][1] + ":" + "2@" + pcs[1][2] + "/" + "void" + ";" + "0@" + pcs[2][0] + ":" + "1@" + pcs[2][1] + ":" + "2@" + pcs[2][2] + "/" + "_" + ";" + "0@" + pcs[3][0] + ":" + "1@" + pcs[3][1] + ":" + "2@" + pcs[3][2] + "/" + r1;
    }
}
