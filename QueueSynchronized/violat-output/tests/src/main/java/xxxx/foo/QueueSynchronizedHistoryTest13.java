...
@State
public class QueueSynchronizedHistoryTest13 {
    ...
    public void actor0(StringResult2 result) {
        ...
        result.r1 = "1@" + pcs[0][0] + "/" + "_" + ";" + "1@" + pcs[1][0] + "/" + r0 + ";" + "1@" + pcs[2][0] + "/" + "_" + ";" + "1@" + pcs[3][0] + "/" + "void";
    }
    ...
    public void actor1(StringResult2 result) {
        ...
        result.r2 = "0@" + pcs[0][0] + "/" + "_" + ";" + "0@" + pcs[1][0] + "/" + r0 + ";" + "0@" + pcs[2][0] + "/" + "_" + ";" + "0@" + pcs[3][0] + "/" + r1 + ";" + "0@" + pcs[4][0] + "/" + "_" + ";" + "0@" + pcs[5][0] + "/" + r2;
    }
}
