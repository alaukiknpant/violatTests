...
@State
public class QueueSynchronizedHistoryTest12 {
    ...
    public void actor0(StringResult2 result) {
        ...
        result.r1 = "1@" + pcs[0][0] + "/" + "_" + ";" + "1@" + pcs[1][0] + "/" + "void" + ";" + "1@" + pcs[2][0] + "/" + "_" + ";" + "1@" + pcs[3][0] + "/" + r1 + ";" + "1@" + pcs[4][0] + "/" + "_" + ";" + "1@" + pcs[5][0] + "/" + r2 + ";" + "1@" + pcs[6][0] + "/" + "_" + ";" + "1@" + pcs[7][0] + "/" + "void";
    }
