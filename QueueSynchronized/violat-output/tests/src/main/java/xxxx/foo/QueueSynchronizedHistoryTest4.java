...
@State
public class QueueSynchronizedHistoryTest4 {
    ...
    public void actor0(StringResult2 result) {
        ...
        try { pcs[n][0] = pc1.get(); n++; pc0.increment(); r = ResultAdapter.get(obj.toString()); pcs[n][0] = pc1.get(); n++; pc0.increment(); }
        catch (Exception e) { pcs[n][0] = pc1.get(); n++; pc0.increment(); r = ResultAdapter.get(e); }
        r2 = r;
        ...
        result.r1 = "1@" + pcs[0][0] + "/" + "_" + ";" + "1@" + pcs[1][0] + "/" + "void" + ";" + "1@" + pcs[2][0] + "/" + "_" + ";" + "1@" + pcs[3][0] + "/" + r1 + ";" + "1@" + pcs[4][0] + "/" + "_" + ";" + "1@" + pcs[5][0] + "/" + r2 + ";" + "1@" + pcs[6][0] + "/" + "_" + ";" + "1@" + pcs[7][0] + "/" + r3;
    }
