...
@State
public class QueueSynchronizedHistoryTest16 {
    ...
    public void actor0(StringResult3 result) {
        ...
        result.r1 = "1@" + pcs[0][0] + ":" + "2@" + pcs[0][1] + "/" + "_" + ";" + "1@" + pcs[1][0] + ":" + "2@" + pcs[1][1] + "/" + "void" + ";" + "1@" + pcs[2][0] + ":" + "2@" + pcs[2][1] + "/" + "_" + ";" + "1@" + pcs[3][0] + ":" + "2@" + pcs[3][1] + "/" + "void" + ";" + "1@" + pcs[4][0] + ":" + "2@" + pcs[4][1] + "/" + "_" + ";" + "1@" + pcs[5][0] + ":" + "2@" + pcs[5][1] + "/" + r2;
    }
    ...
    public void actor2(StringResult3 result) {
        ...
        try { pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); n++; pc2.increment(); obj.put(1); pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); n++; pc2.increment(); }
        catch (Exception e) { pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); n++; pc2.increment(); }
        
        result.r3 = "0@" + pcs[0][0] + ":" + "1@" + pcs[0][1] + "/" + "_" + ";" + "0@" + pcs[1][0] + ":" + "1@" + pcs[1][1] + "/" + "void";
    }
}
