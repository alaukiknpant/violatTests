...
@State
public class QueueSynchronizedHistoryTest19 {
    ...
    public void actor0(StringResult4 result) {
        ...
        try { pcs[n][0] = pc1.get(); pcs[n][1] = pc2.get(); pcs[n][2] = pc3.get(); n++; pc0.increment(); r = ResultAdapter.get(obj.toString()); pcs[n][0] = pc1.get(); pcs[n][1] = pc2.get(); pcs[n][2] = pc3.get(); n++; pc0.increment(); }
        ...
        try { pcs[n][0] = pc1.get(); pcs[n][1] = pc2.get(); pcs[n][2] = pc3.get(); n++; pc0.increment(); obj.put(0); pcs[n][0] = pc1.get(); pcs[n][1] = pc2.get(); pcs[n][2] = pc3.get(); n++; pc0.increment(); }
        catch (Exception e) { pcs[n][0] = pc1.get(); pcs[n][1] = pc2.get(); pcs[n][2] = pc3.get(); n++; pc0.increment(); }
        
        result.r1 = "1@" + pcs[0][0] + ":" + "2@" + pcs[0][1] + ":" + "3@" + pcs[0][2] + "/" + "_" + ";" + "1@" + pcs[1][0] + ":" + "2@" + pcs[1][1] + ":" + "3@" + pcs[1][2] + "/" + r0 + ";" + "1@" + pcs[2][0] + ":" + "2@" + pcs[2][1] + ":" + "3@" + pcs[2][2] + "/" + "_" + ";" + "1@" + pcs[3][0] + ":" + "2@" + pcs[3][1] + ":" + "3@" + pcs[3][2] + "/" + "void" + ";" + "1@" + pcs[4][0] + ":" + "2@" + pcs[4][1] + ":" + "3@" + pcs[4][2] + "/" + "_" + ";" + "1@" + pcs[5][0] + ":" + "2@" + pcs[5][1] + ":" + "3@" + pcs[5][2] + "/" + "void";
    }
    ...
    public void actor1(StringResult4 result) {
        ...
        try { pcs[n][0] = pc0.get(); pcs[n][1] = pc2.get(); pcs[n][2] = pc3.get(); n++; pc1.increment(); obj.put(1); pcs[n][0] = pc0.get(); pcs[n][1] = pc2.get(); pcs[n][2] = pc3.get(); n++; pc1.increment(); }
    ...
    public void actor2(StringResult4 result) {
        ...
        try { pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc3.get(); n++; pc2.increment(); obj.put(1); pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc3.get(); n++; pc2.increment(); }
        catch (Exception e) { pcs[n][0] = pc0.get(); pcs[n][1] = pc1.get(); pcs[n][2] = pc3.get(); n++; pc2.increment(); }
        
        result.r3 = "0@" + pcs[0][0] + ":" + "1@" + pcs[0][1] + ":" + "3@" + pcs[0][2] + "/" + "_" + ";" + "0@" + pcs[1][0] + ":" + "1@" + pcs[1][1] + ":" + "3@" + pcs[1][2] + "/" + "void";
    }
    ...
    public void actor3(StringResult4 result) {
        ...
        result.r4 = "0@" + pcs[0][0] + ":" + "1@" + pcs[0][1] + ":" + "2@" + pcs[0][2] + "/" + "_" + ";" + "0@" + pcs[1][0] + ":" + "1@" + pcs[1][1] + ":" + "2@" + pcs[1][2] + "/" + "void";
    }
}
